    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12">
      <div className="container-custom">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Track player performance across matches</p>
        </div>
...
function StatRow({ stat, isAdmin, onUpdate, onDelete, editingCell, setEditingCell }: {
  ...
  const CheckboxCell = ({ field, checked }: { field: string; checked: boolean }) => (
    <input
      type="checkbox"
      checked={checked}
      onChange={(e) => isAdmin && onUpdate(stat.id, field, e.target.checked)}
      disabled={!isAdmin}
  ...
  return (
    <tr className="hover:bg-gray-50">
      ...
      <td className="px-6 py-4 text-center whitespace-nowrap">
        <div className="flex justify-center">
          <CheckboxCell field="not_out" checked={stat.not_out} />
        </div>
      </td>
      <td className="px-6 py-4 text-center text-sm whitespace-nowrap">
